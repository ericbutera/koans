...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject appears to provide the start value for first parameter of block
    result3 = [0].inject(7777) { |hundred, item| hundred }
    assert_equal 7777, result3
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    bikes = ['BMC', 'YETI', 'CINELLI']
    bikes2 = bikes.map { |bike| bike << "!" }
    assert_equal bikes2, ['BMC!', 'YETI!', 'CINELLI!']
  end
