...
class AboutSymbols < Neo::Koan
  ...
  # 
  # ~~ease of dynamic programming?~~
  # ~~maybe its hard to create a symbol from a string~~ .to_sym
  # because creating a symbol to test the symbols existance... well that would be a self-fulfilling prophecy
  ...
  # performance. entire point is to be low cpu (search) and low memory  ??
end
